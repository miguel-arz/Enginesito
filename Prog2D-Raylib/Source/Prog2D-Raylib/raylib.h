...
RLAPI void CloseAppWindow(void);                                     // Close window and unload OpenGL context
...
RLAPI void DrawTextureProUV(Texture2D texture, Vector4 uvs, Rectangle dest, Vector2 origin, float rotation, Color tint);
